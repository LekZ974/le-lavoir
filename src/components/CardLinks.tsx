...
const FacebookIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    viewBox="0 0 512 512"
  >
    <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V334.58h-59.67v-78.52h59.67v-60.75c0-57.72 34.63-89.98 85.69-89.98 24.57 0 50.12 4.38 50.12 4.38v55.13h-28.08c-33.69 0-44.31 20.92-44.31 42.39v51.63h68.78l-11 78.52h-57.78V501C413.31 482.38 504 379.78 504 256z" />
  </svg>
);
  ...
  return (
    <Card className="w-full px-4 py-16 overflow-hidden sm:px-16">
      <div className="items-center gap-6 text-center md:text-left col ">
        <GradientText>{t("social.follow_us")}</GradientText>
        <div className="flex gap-4 items-center justify-center md:justify-start">
          <a
            href="https://www.instagram.com/le_lavoir_de_la_passerelle/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex gap-4 items-center"
          >
            <InstagramIcon className="w-12 h-12 text-extra-strong hover:title-md" />
          </a>
          <a
            href="https://www.facebook.com/profile.php?id=61577023506091"
            target="_blank"
            rel="noopener noreferrer"
            className="flex gap-4 items-center"
          >
            <FacebookIcon className="w-12 h-12 text-extra-strong hover:title-md" />
          </a>
        </div>
      </div>
    </Card>

...
const CardFeatureText = ({ name, title }: { name?: string; title: string }) => {
  return (
    <>
    ...
    <>
      ...
      <FeatureSection>
        <Text>
          ...
          <Details className="text-extra-light">{t("pricing.text")}</Details>
        </Text>
      ...
      <FeatureSection grayer right>
        <Text>
          ...
          <Details>{t("machines.description")}</Details>
          <Details>{t("machines.maintenance")}</Details>
        </Text>
            ...
            <div className="flip-box-back bg-extra-strong">
              <div className="row gap-6 pt-6">
                <CardFeature className="p-6">
                  <CardFeatureText title={t("machines.experience1")} />
                </CardFeature>
                <CardFeature className="p-6">
                  <CardFeatureText title={t("machines.experience2")} />
                </CardFeature>
              </div>
              <div className="row gap-6 pt-6">
                <CardFeature className="p-6">
                  <CardFeatureText title={t("machines.experience3")} />
                </CardFeature>
                <CardFeature className="p-6">
                  <CardFeatureText title={t("machines.experience4")} />
                </CardFeature>
              </div>
            </div>
          </div>
      ...
      <FeatureSection>
        <Text>
          ...
          <GradientText>{t("sustainable.subtitle")}</GradientText>
          <Details className="text-extra-light">
            {t("sustainable.text")}
          </Details>
        </Text>
        <div
          className="col gap-6 md:w-1/3 items-center"
